...
from deepagents.middleware.permissions import ExecutePermission, FilesystemPermission, TaskPermission, _PermissionMiddleware
...
def create_deep_agent(  # noqa: C901, PLR0912, PLR0915  # Complex graph assembly logic with many conditional branches
    ...
    *,
    ...
    permissions: list[FilesystemPermission | ExecutePermission | TaskPermission] | None = None,
    ...
    Args:
        ...
        permissions: List of ``FilesystemPermission``, ``ExecutePermission``, and/or
            ``TaskPermission`` rules for the main agent and its subagents.
