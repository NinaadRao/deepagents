...
## [0.2.0](https://github.com/NinaadRao/deepagents/compare/deepagents-code==0.1.53...deepagents-code==0.2.0) (2026-08-06)


### ⚠ BREAKING CHANGES

* **sdk,code,quickjs:** make the `ToDoListMiddleware` list opt-in ([#4929](https://github.com/NinaadRao/deepagents/issues/4929))

### Features

* **code,evals:** GLM-5.2 harness profile ([#4710](https://github.com/NinaadRao/deepagents/issues/4710)) ([47cfc33](https://github.com/NinaadRao/deepagents/commit/47cfc33cf9145347b57eb2daf6ef82cdaa342ca4))
* **code:** `/model` footer Ctrl+N hint follows display mode ([#5247](https://github.com/NinaadRao/deepagents/issues/5247)) ([cf87266](https://github.com/NinaadRao/deepagents/commit/cf87266105ee6ed79e56d72dea58c1c5f431228f))
* **code:** `/tools` slash command ([#4649](https://github.com/NinaadRao/deepagents/issues/4649)) ([b1600a8](https://github.com/NinaadRao/deepagents/commit/b1600a8da784899d9db5bdf93be07b4c7f53a46c))
* **code:** `dcode config get` accepts sections ([#5134](https://github.com/NinaadRao/deepagents/issues/5134)) ([874a137](https://github.com/NinaadRao/deepagents/commit/874a137f7bf694f647f6f1dcbcf563eae5589ef2))
* **code:** `dcode_term_program` trace metadata ([#5329](https://github.com/NinaadRao/deepagents/issues/5329)) ([8d3a1a9](https://github.com/NinaadRao/deepagents/commit/8d3a1a929f7569630060ab68862b2a21c382d58c))
* **code:** add "always allow" to project MCP approval prompt ([#4562](https://github.com/NinaadRao/deepagents/issues/4562)) ([ffab82a](https://github.com/NinaadRao/deepagents/commit/ffab82a9458d2a03b95cbc515f883212090a6992))
* **code:** add `--allow-fs-tools` filesystem tool allowlist to dcode ([#4635](https://github.com/NinaadRao/deepagents/issues/4635)) ([3fbb85e](https://github.com/NinaadRao/deepagents/commit/3fbb85e3565f270f3a567f771ebd28323f10245d))
* **code:** add `Ctrl+X` to goal review editing ([#4780](https://github.com/NinaadRao/deepagents/issues/4780)) ([641b906](https://github.com/NinaadRao/deepagents/commit/641b906157db2c6ae476805f0714ae8f51040492))
* **code:** add `install` subcommand ([#5080](https://github.com/NinaadRao/deepagents/issues/5080)) ([2f2116d](https://github.com/NinaadRao/deepagents/commit/2f2116d5cd7bba98e1b0731d5da760a4b93ffb37))
* **code:** add `memory.auto_save` config flag ([#4700](https://github.com/NinaadRao/deepagents/issues/4700)) ([55b60ca](https://github.com/NinaadRao/deepagents/commit/55b60ca08da4eef294ac3c162610b2a151584ea5))
* **code:** add `reconnect`/`connect` hidden keywords for `/restart` ([#4807](https://github.com/NinaadRao/deepagents/issues/4807)) ([99250ee](https://github.com/NinaadRao/deepagents/commit/99250ee1749c977e95389baafde3d358c953ea0f))
* **code:** add Baseten built-in pricing overrides ([#5312](https://github.com/NinaadRao/deepagents/issues/5312)) ([f34ffa0](https://github.com/NinaadRao/deepagents/commit/f34ffa0cb8c0c7943b116a753535df47e32de2a3))
* **code:** add built-in thread inspector skill ([#4769](https://github.com/NinaadRao/deepagents/issues/4769)) ([2d729b3](https://github.com/NinaadRao/deepagents/commit/2d729b30c5df7265e8062bccd38026b745c6cf02))
* **code:** add configurable chat cursor style ([#4687](https://github.com/NinaadRao/deepagents/issues/4687)) ([a22484b](https://github.com/NinaadRao/deepagents/commit/a22484ba2e001fd62fbff0fe916f1b3b93889fc3))
* **code:** add Fireworks `kimi-k3` to model switcher ([#5082](https://github.com/NinaadRao/deepagents/issues/5082)) ([82e799c](https://github.com/NinaadRao/deepagents/commit/82e799c7191adcb3bf96eb0435d55edd58cc1883))
* **code:** add GLM-5.2-Fast and Kimi-K3 to recommended models ([#5072](https://github.com/NinaadRao/deepagents/issues/5072)) ([a33494e](https://github.com/NinaadRao/deepagents/commit/a33494ec580c289c58f725e19364fc21ef8cc26c))
* **code:** add Hooks v2 capability snapshots ([#4916](https://github.com/NinaadRao/deepagents/issues/4916)) ([8b4e508](https://github.com/NinaadRao/deepagents/commit/8b4e508d4664ef02e220854d50f5d98e0913aed8))
* **code:** add Hooks v2 execution engine ([#4880](https://github.com/NinaadRao/deepagents/issues/4880)) ([f0b198f](https://github.com/NinaadRao/deepagents/commit/f0b198faa220ad90f24713f08acc09d41e4a81de))
* **code:** add Hooks v2 session transcripts ([#4918](https://github.com/NinaadRao/deepagents/issues/4918)) ([ca86fbe](https://github.com/NinaadRao/deepagents/commit/ca86fbecca1a43facb4281397760c5e52edb1ddd))
* **code:** add interactive goal management ([#4693](https://github.com/NinaadRao/deepagents/issues/4693)) ([64205e2](https://github.com/NinaadRao/deepagents/commit/64205e238c280ae05b2bf9253ac40c6f85ffb49c))
* **code:** add Kimi K3 to model selector under OpenRouter ([#4803](https://github.com/NinaadRao/deepagents/issues/4803)) ([fc94bb7](https://github.com/NinaadRao/deepagents/commit/fc94bb7da9e66218de063aa4415dcf9717f15fce))
* **code:** add plugin list search ([#4765](https://github.com/NinaadRao/deepagents/issues/4765)) ([a6c20b1](https://github.com/NinaadRao/deepagents/commit/a6c20b1a4d2a8b8a03690460a30c501ab7fbb6cb))
* **code:** add plugin marketplace support ([#4554](https://github.com/NinaadRao/deepagents/issues/4554)) ([0187d14](https://github.com/NinaadRao/deepagents/commit/0187d14b83301c116a2f177e6e04ae7a8cc99ca7))
* **code:** add project hooks workspace trust ([#5105](https://github.com/NinaadRao/deepagents/issues/5105)) ([9b2185b](https://github.com/NinaadRao/deepagents/commit/9b2185b65d4cbbaad9dd1b632162810a0aefd7eb))
* **code:** add typed hooks data models ([#4870](https://github.com/NinaadRao/deepagents/issues/4870)) ([0967012](https://github.com/NinaadRao/deepagents/commit/09670121b8d20fa8029804143852f6fcc6135dba))
* **code:** allow muting the "YOLO is active" toast ([#5103](https://github.com/NinaadRao/deepagents/issues/5103)) ([4d2d6ae](https://github.com/NinaadRao/deepagents/commit/4d2d6aed808575e2e03539bc7fa84562c93b7eb5))
* **code:** auto-accept `/goal` criteria in YOLO mode ([#4784](https://github.com/NinaadRao/deepagents/issues/4784)) ([cc662f2](https://github.com/NinaadRao/deepagents/commit/cc662f236dbf72303be5cbf2c4cfd00710a2d32c))
* **code:** classifier-backed Auto approval mode ([#4804](https://github.com/NinaadRao/deepagents/issues/4804)) ([eae7c28](https://github.com/NinaadRao/deepagents/commit/eae7c28f1152a5116b5b330c9fa1088ce173656d))
* **code:** click the splash `thread` ID to copy it ([#5173](https://github.com/NinaadRao/deepagents/issues/5173)) ([be2e505](https://github.com/NinaadRao/deepagents/commit/be2e5054b9dffdf9ba9032a198c0ae5f8a0cccd1))
* **code:** configurable Auto classifier review timeout ([#5302](https://github.com/NinaadRao/deepagents/issues/5302)) ([7bd977b](https://github.com/NinaadRao/deepagents/commit/7bd977bc9d4c11aad90dbef7872d83c2affd584e))
* **code:** configure Auto goal criteria acceptance ([#4940](https://github.com/NinaadRao/deepagents/issues/4940)) ([37addfc](https://github.com/NinaadRao/deepagents/commit/37addfc8bb5533d6670d14defea38770c8d54d1e))
* **code:** Debug Console thread ID click-to-copy with LangSmith link ([#4760](https://github.com/NinaadRao/deepagents/issues/4760)) ([2d35507](https://github.com/NinaadRao/deepagents/commit/2d35507b5c7ff7f504f3d294ac499140752c4f59))
* **code:** debug-log skill-name override collisions ([#4772](https://github.com/NinaadRao/deepagents/issues/4772)) ([77603c6](https://github.com/NinaadRao/deepagents/commit/77603c69e2eeededf6f1df68b384da27f7d2843f))
* **code:** drop `TodoListMiddleware` ([#4685](https://github.com/NinaadRao/deepagents/issues/4685)) ([d3a3077](https://github.com/NinaadRao/deepagents/commit/d3a3077e8536696dcf4a9dcd8555e9c871562e74))
* **code:** drop redundant `shell` and `web_search` prompt guidance ([#5213](https://github.com/NinaadRao/deepagents/issues/5213)) ([6305fdb](https://github.com/NinaadRao/deepagents/commit/6305fdbf8d94d061193a908715f2c629893b47ff))
* **code:** escape to manual mode in YOLO notice, mode slash commands ([#5092](https://github.com/NinaadRao/deepagents/issues/5092)) ([d93336b](https://github.com/NinaadRao/deepagents/commit/d93336bfca4664abc3994cb28970ea3fbeeb1b77))
* **code:** expand environment variables in MCP config ([#4681](https://github.com/NinaadRao/deepagents/issues/4681)) ([4f5d7be](https://github.com/NinaadRao/deepagents/commit/4f5d7be1b4073dee346e5a974841721646fa4860))
* **code:** expand truncated `task` descriptions on click or `Ctrl+O` ([#4811](https://github.com/NinaadRao/deepagents/issues/4811)) ([2ddb551](https://github.com/NinaadRao/deepagents/commit/2ddb551bd77d210d689f3a75037259ade4fbf54a))
* **code:** frame HITL rejection reasons for the model ([#5259](https://github.com/NinaadRao/deepagents/issues/5259)) ([89c814b](https://github.com/NinaadRao/deepagents/commit/89c814b29249b44a8a6122f6c359db3601a6802e))
* **code:** gate debug console click-to-copy behind a checkbox ([#4810](https://github.com/NinaadRao/deepagents/issues/4810)) ([a485404](https://github.com/NinaadRao/deepagents/commit/a4854042e5fe9f3acf629b0646a6bf8e348ccc9a))
* **code:** improve `/goal` criteria UX ([#4694](https://github.com/NinaadRao/deepagents/issues/4694)) ([06f46ff](https://github.com/NinaadRao/deepagents/commit/06f46fffe36efa9f3adcb331b07df283d8bed874))
* **code:** in-app Debug Console ([#4564](https://github.com/NinaadRao/deepagents/issues/4564)) ([4f94a30](https://github.com/NinaadRao/deepagents/commit/4f94a30c11efb1819b08647d15b50b9b1e7bf043))
* **code:** include `yolo` mode in `Shift+Tab` approval cycle ([#5035](https://github.com/NinaadRao/deepagents/issues/5035)) ([9f2cc21](https://github.com/NinaadRao/deepagents/commit/9f2cc212dc3ba59540a9f738d2849e38ac9ecfc2))
* **code:** integrate Hooks v2 client lifecycle events ([#5104](https://github.com/NinaadRao/deepagents/issues/5104)) ([e8702df](https://github.com/NinaadRao/deepagents/commit/e8702df601e137b65fe276270c3d3d589340bddf))
* **code:** integrate Hooks v2 server lifecycle events ([#4997](https://github.com/NinaadRao/deepagents/issues/4997)) ([2487c4b](https://github.com/NinaadRao/deepagents/commit/2487c4b87dff264ae1e8d34c7ce9249dd4b29760))
* **code:** let the rubric grader inspect working-directory files ([#4835](https://github.com/NinaadRao/deepagents/issues/4835)) ([5dcf749](https://github.com/NinaadRao/deepagents/commit/5dcf749a6e7d5ab6611f30d485a3382c7ef31f22))
* **code:** load hooks from installed plugins ([#5198](https://github.com/NinaadRao/deepagents/issues/5198)) ([0828b02](https://github.com/NinaadRao/deepagents/commit/0828b02d30c7b5557ecfce7c4a4039e0d9c4c571))
* **code:** local pricing overrides as a fallback when genai-prices misses ([#5304](https://github.com/NinaadRao/deepagents/issues/5304)) ([89bcaf2](https://github.com/NinaadRao/deepagents/commit/89bcaf2c31ab347cb4cb4563bc18f296dbecea08))
* **code:** make Hooks v2 generally available ([#5307](https://github.com/NinaadRao/deepagents/issues/5307)) ([4edebde](https://github.com/NinaadRao/deepagents/commit/4edebdedd61d6793f0f7b666f5ee26b414576805))
* **code:** make plugins generally available ([#4797](https://github.com/NinaadRao/deepagents/issues/4797)) ([3da6e47](https://github.com/NinaadRao/deepagents/commit/3da6e471c26f1da4cddeb12a435bab92bd7866c6))
* **code:** make Version, Model, CWD copyable in Debug Console ([#4975](https://github.com/NinaadRao/deepagents/issues/4975)) ([52b8993](https://github.com/NinaadRao/deepagents/commit/52b8993489a9b6b92be077fe835743ef7704b6a0))
* **code:** migrate legacy hooks to v2 events ([#4971](https://github.com/NinaadRao/deepagents/issues/4971)) ([fdb585c](https://github.com/NinaadRao/deepagents/commit/fdb585c87b054979b8440bdc6ac97fc8ae628134))
* **code:** move `/goal` criteria generation server-side ([#4754](https://github.com/NinaadRao/deepagents/issues/4754)) ([9fdd498](https://github.com/NinaadRao/deepagents/commit/9fdd498937842e2ac490ae0e0ca74eef47abd0bb))
* **code:** persist Debug Console `Ctrl+L` clear across reopen ([#4812](https://github.com/NinaadRao/deepagents/issues/4812)) ([20089a5](https://github.com/NinaadRao/deepagents/commit/20089a53703b031726fdc898831bb09f434527b7))
* **code:** persist reasoning effort across restarts ([#4728](https://github.com/NinaadRao/deepagents/issues/4728)) ([c584dcf](https://github.com/NinaadRao/deepagents/commit/c584dcfb3ad287446e0209b8bd4ca31cee587eea))
* **code:** point back to the previous thread after a switch ([#5172](https://github.com/NinaadRao/deepagents/issues/5172)) ([4507f9f](https://github.com/NinaadRao/deepagents/commit/4507f9f1985f29e9d4af7577293da64ec12b131c))
* **code:** prompt to reconnect when leaving `/mcp` with pending toggles ([#5211](https://github.com/NinaadRao/deepagents/issues/5211)) ([53d1fb8](https://github.com/NinaadRao/deepagents/commit/53d1fb80cbd43f983782975d540fac34a11c4ccc))
* **code:** raise agent recursion limit to 2000 and make it configurable ([#4994](https://github.com/NinaadRao/deepagents/issues/4994)) ([94962a5](https://github.com/NinaadRao/deepagents/commit/94962a5f588ce84991ad382b7713155d6a5a231e))
* **code:** recognize LangSmith Gateway credentials ([#5042](https://github.com/NinaadRao/deepagents/issues/5042)) ([dcbff9c](https://github.com/NinaadRao/deepagents/commit/dcbff9c4d046bcd38ceef8e362691e8030036213))
* **code:** recommend DeepSeek V4 Flash 0731 ([#5244](https://github.com/NinaadRao/deepagents/issues/5244)) ([fbe4ec8](https://github.com/NinaadRao/deepagents/commit/fbe4ec8046c35313c6c05a986779111d84fe2536))
* **code:** refresh price catalog hourly in the background ([#5264](https://github.com/NinaadRao/deepagents/issues/5264)) ([2454afa](https://github.com/NinaadRao/deepagents/commit/2454afa58521f9dddb64bbde364a475694f45f4d))
* **code:** replace Gemini 3.5 Flash with 3.6 Flash in model switcher ([#4890](https://github.com/NinaadRao/deepagents/issues/4890)) ([5c99687](https://github.com/NinaadRao/deepagents/commit/5c99687bdecfd9e33051373581cacddbf7d0202a))
* **code:** running session cost in status bar and usage ([#5036](https://github.com/NinaadRao/deepagents/issues/5036)) ([539d4a0](https://github.com/NinaadRao/deepagents/commit/539d4a04380182438ca63ba6b902eb921dc8a600))
* **code:** selectable model for the Auto approval classifier ([#5205](https://github.com/NinaadRao/deepagents/issues/5205)) ([1d3feb1](https://github.com/NinaadRao/deepagents/commit/1d3feb1275a875f84f96f04a07e47cb6ec974b78))
* **code:** show `ask_user` answers on the answered tool row ([#5100](https://github.com/NinaadRao/deepagents/issues/5100)) ([78ebe2d](https://github.com/NinaadRao/deepagents/commit/78ebe2d27c0ec5b5bf1368f1f1b1f442f9212717))
* **code:** show changelog link before install-script update prompt ([#5034](https://github.com/NinaadRao/deepagents/issues/5034)) ([e3d2a87](https://github.com/NinaadRao/deepagents/commit/e3d2a870b77e548611929be56952f68825d3d52e))
* **code:** show experimental mode in splash and debug console ([#4863](https://github.com/NinaadRao/deepagents/issues/4863)) ([44d9dec](https://github.com/NinaadRao/deepagents/commit/44d9dec39b2570d16c285a8b0a99cbe1afab4f1b))
* **code:** show thread message count in the Debug Console ([#5117](https://github.com/NinaadRao/deepagents/issues/5117)) ([04cf25d](https://github.com/NinaadRao/deepagents/commit/04cf25d27068070979552a5c914fc7dad715ce70))
* **code:** shutdown toast for deferred exits ([#4830](https://github.com/NinaadRao/deepagents/issues/4830)) ([a8a05f5](https://github.com/NinaadRao/deepagents/commit/a8a05f58f2ffb755bf373cd8f9a4cced2778370c))
* **code:** suggest compacting large resumed threads ([#5318](https://github.com/NinaadRao/deepagents/issues/5318)) ([cb2329d](https://github.com/NinaadRao/deepagents/commit/cb2329d1ec480455a7ba4e2b277cbd727c9215c7))
* **code:** summarize plugin changes on reload ([#4767](https://github.com/NinaadRao/deepagents/issues/4767)) ([9cad2f0](https://github.com/NinaadRao/deepagents/commit/9cad2f00dd0473828f80f782c889b939483727f6))
* **code:** surface Hooks v2 runtime feedback ([#5045](https://github.com/NinaadRao/deepagents/issues/5045)) ([66d526f](https://github.com/NinaadRao/deepagents/commit/66d526f0e43c4c1c5d3ab9cc3d423fefe1606e6f))
* **code:** toast to re-paste when a chat paste collapses ([#4742](https://github.com/NinaadRao/deepagents/issues/4742)) ([e50e238](https://github.com/NinaadRao/deepagents/commit/e50e2383261ba39923b5d6c48b7fe3b058475cd3))
* **code:** trace auto-approve (YOLO) mode in trace metadata ([#4764](https://github.com/NinaadRao/deepagents/issues/4764)) ([d88601e](https://github.com/NinaadRao/deepagents/commit/d88601ed582b89d4a5b517e842029d06370c0891))
* **code:** trace experimental mode in metadata ([#4705](https://github.com/NinaadRao/deepagents/issues/4705)) ([22d5045](https://github.com/NinaadRao/deepagents/commit/22d50456324e9b8c0121a3a06787e19c1b88e1aa))
* **code:** tri-state `DEEPAGENTS_CODE_ONBOARDING` env var ([#5301](https://github.com/NinaadRao/deepagents/issues/5301)) ([43293e9](https://github.com/NinaadRao/deepagents/commit/43293e95cb072c8b92a734eca8c0292e45d279e8))
* **sdk,code,quickjs:** make the `ToDoListMiddleware` list opt-in ([#4929](https://github.com/NinaadRao/deepagents/issues/4929)) ([9340518](https://github.com/NinaadRao/deepagents/commit/9340518a26c4287f9ad0c543edc9b69106c15154))


### Bug Fixes

* **code,evals:** unify goal activation signaling ([#4980](https://github.com/NinaadRao/deepagents/issues/4980)) ([0c4016e](https://github.com/NinaadRao/deepagents/commit/0c4016e3c8a7293fdf1a24e12340759068a2bb9a))
* **code:** abort project MCP approval on Esc ([#4888](https://github.com/NinaadRao/deepagents/issues/4888)) ([46bb1a8](https://github.com/NinaadRao/deepagents/commit/46bb1a86c8041d5c161d7cd07de66d068fb100c0))
* **code:** abort YOLO launch on `Ctrl+C`/`Ctrl+D` ([#4953](https://github.com/NinaadRao/deepagents/issues/4953)) ([e6ab9c0](https://github.com/NinaadRao/deepagents/commit/e6ab9c05e8fcb9a332396a9425e2b302607be823))
* **code:** add marketplaces asynchronously ([#4766](https://github.com/NinaadRao/deepagents/issues/4766)) ([0d1bb6a](https://github.com/NinaadRao/deepagents/commit/0d1bb6a1224b91cae9dcdb7014a6410a82b79001))
* **code:** align context diff rows with changed rows ([#4714](https://github.com/NinaadRao/deepagents/issues/4714)) ([f9915db](https://github.com/NinaadRao/deepagents/commit/f9915db4206ef2d794ad07fdccbdd4ee58963142))
* **code:** allow cleanup of agent-created scratch files ([#4860](https://github.com/NinaadRao/deepagents/issues/4860)) ([fe08582](https://github.com/NinaadRao/deepagents/commit/fe08582a386b86f78f7a8047db067ea45e7e2650))
* **code:** allow safe OS-temp scratch artifacts ([#4869](https://github.com/NinaadRao/deepagents/issues/4869)) ([4330534](https://github.com/NinaadRao/deepagents/commit/4330534d18cbf79260842dde0e0c450312ef55ca))
* **code:** always restart after a successful startup auto-update ([#5317](https://github.com/NinaadRao/deepagents/issues/5317)) ([8cdee15](https://github.com/NinaadRao/deepagents/commit/8cdee15bbc54381229a686f8263656be0202b9b5))
* **code:** anchor toasts above the chat input ([#5101](https://github.com/NinaadRao/deepagents/issues/5101)) ([f1727c7](https://github.com/NinaadRao/deepagents/commit/f1727c785c44809e7b1b7ed8c5d0b31c560ae3ad))
* **code:** authorize Auto actions from active goal/rubric directives ([#5017](https://github.com/NinaadRao/deepagents/issues/5017)) ([728dbe7](https://github.com/NinaadRao/deepagents/commit/728dbe7df62ad9960f21cabd6e6c37e8d9a66da7))
* **code:** avoid blocking MCP OAuth token refresh ([#4770](https://github.com/NinaadRao/deepagents/issues/4770)) ([3b2ffce](https://github.com/NinaadRao/deepagents/commit/3b2ffce923e06370efe177e9ca91f70e86f19602))
* **code:** avoid redundant Auto approval prompts ([#4993](https://github.com/NinaadRao/deepagents/issues/4993)) ([9975874](https://github.com/NinaadRao/deepagents/commit/9975874d897ada8979c084145eb730e15c9cf979))
* **code:** avoid tracking inline restart callers ([#4894](https://github.com/NinaadRao/deepagents/issues/4894)) ([0b071ef](https://github.com/NinaadRao/deepagents/commit/0b071ef71a1f0d63cb09de7ac528e030cd75af2e))
* **code:** bound Hooks v2 session-end teardown ([#5248](https://github.com/NinaadRao/deepagents/issues/5248)) ([28a7d5b](https://github.com/NinaadRao/deepagents/commit/28a7d5bdd3f78044b4f3612f71e13ce38ef47bf4))
* **code:** bust CDN cache on forced `dcode update` checks ([#4862](https://github.com/NinaadRao/deepagents/issues/4862)) ([3733526](https://github.com/NinaadRao/deepagents/commit/3733526f5faa187627c650435fa5478754c55fb4))
* **code:** capture input typed before TUI startup ([#4684](https://github.com/NinaadRao/deepagents/issues/4684)) ([ef9a4a8](https://github.com/NinaadRao/deepagents/commit/ef9a4a8770f4daec70e640d6d2f23dd798d4ede2))
* **code:** clarify plugin component discovery and reload status ([#4774](https://github.com/NinaadRao/deepagents/issues/4774)) ([7d707b8](https://github.com/NinaadRao/deepagents/commit/7d707b840f132ad65e5ac8443ec7fece393180f8))
* **code:** clean offloaded history when deleting a thread ([#4751](https://github.com/NinaadRao/deepagents/issues/4751)) ([47788ed](https://github.com/NinaadRao/deepagents/commit/47788ededafd44f74b4368ec6793bf4685ad3a3a))
* **code:** close subprocess transport on install teardown ([#4735](https://github.com/NinaadRao/deepagents/issues/4735)) ([625e601](https://github.com/NinaadRao/deepagents/commit/625e601da8cd77e13b98b2b81626f320478108dc))
* **code:** complete goals after satisfied grading ([#4781](https://github.com/NinaadRao/deepagents/issues/4781)) ([682ce0f](https://github.com/NinaadRao/deepagents/commit/682ce0fc760e96cf546ea9c97050293548aebc45))
* **code:** consistent modal backdrop dimming for selectors ([#4990](https://github.com/NinaadRao/deepagents/issues/4990)) ([3606e3f](https://github.com/NinaadRao/deepagents/commit/3606e3f3fa2faac97f30141f9ee54e37631d16ad))
* **code:** consistent styling and links for thread status messages ([#5118](https://github.com/NinaadRao/deepagents/issues/5118)) ([9ad8dde](https://github.com/NinaadRao/deepagents/commit/9ad8dded08533a7915dc35e05f4c92c3b1ecb736))
* **code:** correct editable SDK detection to scan and correlate ([#5199](https://github.com/NinaadRao/deepagents/issues/5199)) ([4693ee7](https://github.com/NinaadRao/deepagents/commit/4693ee774771c5936ffa1783396aa4e2126211b1))
* **code:** count only running tools in live tool-group line ([#4809](https://github.com/NinaadRao/deepagents/issues/4809)) ([4d483fd](https://github.com/NinaadRao/deepagents/commit/4d483fdf39b6d7c691322041a4fc58be06ecfd6b))
* **code:** dedupe Auto classifier-unavailable transcript spam ([#5013](https://github.com/NinaadRao/deepagents/issues/5013)) ([9500306](https://github.com/NinaadRao/deepagents/commit/9500306a17f90dc2f27897c364c24cafffbc474a))
* **code:** deduplicate content from system prompt by overwriting base prompt ([#4516](https://github.com/NinaadRao/deepagents/issues/4516)) ([2266f58](https://github.com/NinaadRao/deepagents/commit/2266f58e4713d23ba0b30eb8646424d01165c11b))
* **code:** disable LangSmith secret redaction by default ([#4970](https://github.com/NinaadRao/deepagents/issues/4970)) ([d029585](https://github.com/NinaadRao/deepagents/commit/d029585ab79432d00edfa5a70e77a31f2388ed5b))
* **code:** disentangle version diagnostics for editable installs ([#4816](https://github.com/NinaadRao/deepagents/issues/4816)) ([7408378](https://github.com/NinaadRao/deepagents/commit/7408378896344e4db7dbc45a35ae6b02cc746d31))
* **code:** dismiss startup tip on `-m` initial submission ([#4779](https://github.com/NinaadRao/deepagents/issues/4779)) ([8acd414](https://github.com/NinaadRao/deepagents/commit/8acd414a2e712d8b8b1968e40bff40483196856b))
* **code:** drop `uv install` tip from `/version` update hint ([#4822](https://github.com/NinaadRao/deepagents/issues/4822)) ([4e618f0](https://github.com/NinaadRao/deepagents/commit/4e618f07b4b00f94133b4d1c105011c438cb35be))
* **code:** drop redundant `/restart` hint from restart prompt ([#5083](https://github.com/NinaadRao/deepagents/issues/5083)) ([b34899f](https://github.com/NinaadRao/deepagents/commit/b34899fccd051ab741000c771eef9a2dc4439d80))
* **code:** explain why `doctor` has no latest-version answer ([#5209](https://github.com/NinaadRao/deepagents/issues/5209)) ([ef3e078](https://github.com/NinaadRao/deepagents/commit/ef3e078795e01b8334151081d026d6a88268d5a9))
* **code:** fire `PreCompact` before auto-compaction ([#5277](https://github.com/NinaadRao/deepagents/issues/5277)) ([f4cc516](https://github.com/NinaadRao/deepagents/commit/f4cc5160c75eb44e8ddee8b049048690ea0f8616))
* **code:** flag empty env override shadowing LangSmith key in `/trace` ([#4996](https://github.com/NinaadRao/deepagents/issues/4996)) ([313f952](https://github.com/NinaadRao/deepagents/commit/313f9520cef28c105aa53eac645176d422ec4a97))
* **code:** gate Hooks v2 behind `DEEPAGENTS_CODE_EXPERIMENTAL` ([#5146](https://github.com/NinaadRao/deepagents/issues/5146)) ([7d4acb6](https://github.com/NinaadRao/deepagents/commit/7d4acb6804cd17eb4c2337b9af11aee9f3601d01))
* **code:** give `config get` a useful missing-key message ([#4976](https://github.com/NinaadRao/deepagents/issues/4976)) ([260c33e](https://github.com/NinaadRao/deepagents/commit/260c33ee28ade91741ba226ef3e719b6b8c8c02c))
* **code:** handle malformed hook resumes ([#5233](https://github.com/NinaadRao/deepagents/issues/5233)) ([bd562c8](https://github.com/NinaadRao/deepagents/commit/bd562c879ad3a8eec0a930bba23ef57fee163c05))
* **code:** harden Hooks v2 command execution ([#4917](https://github.com/NinaadRao/deepagents/issues/4917)) ([05dd0d1](https://github.com/NinaadRao/deepagents/commit/05dd0d1bee7d79be6ac7f18db0d05b521e760326))
* **code:** harden installer downloads and paths ([#4871](https://github.com/NinaadRao/deepagents/issues/4871)) ([9a5bbeb](https://github.com/NinaadRao/deepagents/commit/9a5bbeb7558405054e970decfc1aef5b96a026f3))
* **code:** hide `Auto` option in approval widget when ineligible ([#4839](https://github.com/NinaadRao/deepagents/issues/4839)) ([1a1f06f](https://github.com/NinaadRao/deepagents/commit/1a1f06f506d5a167609de336cced740151b6615a))
* **code:** hide timestamp footers with the rows they belong to ([#5167](https://github.com/NinaadRao/deepagents/issues/5167)) ([a3e3798](https://github.com/NinaadRao/deepagents/commit/a3e3798599705afd2d0a3fce8116df61f22a551d))
* **code:** honor MCP server disables for plugins ([#4848](https://github.com/NinaadRao/deepagents/issues/4848)) ([eea0a84](https://github.com/NinaadRao/deepagents/commit/eea0a84d9621565a707c161c2f22878771d9b38b))
* **code:** hydrate transcript tail when scrolled to the bottom edge ([#4733](https://github.com/NinaadRao/deepagents/issues/4733)) ([02a2461](https://github.com/NinaadRao/deepagents/commit/02a246144c764a1c57b60223652ade8716c7529b))
* **code:** hydrate virtualized transcript on scroll offset changes ([#4646](https://github.com/NinaadRao/deepagents/issues/4646)) ([f77eeb0](https://github.com/NinaadRao/deepagents/commit/f77eeb0a036281f84bf7d0b05ea60e02630f55c1))
* **code:** ignore LangSmith default US endpoint as custom target ([#5022](https://github.com/NinaadRao/deepagents/issues/5022)) ([ffb7aab](https://github.com/NinaadRao/deepagents/commit/ffb7aabe25d3d5ad7c5fce139f3bc3e14e245adf))
* **code:** ignore mouse hits on detached widgets ([#5114](https://github.com/NinaadRao/deepagents/issues/5114)) ([d4d2b60](https://github.com/NinaadRao/deepagents/commit/d4d2b60e37ae034e69f60ab5f34267b542c00dd5))
* **code:** improve `/rubric` help and empty-state messaging ([#5015](https://github.com/NinaadRao/deepagents/issues/5015)) ([1a3f46b](https://github.com/NinaadRao/deepagents/commit/1a3f46b85861779ed44e880cc7921cdd6f28fdfa))
* **code:** improve empty marketplace onboarding and list polish ([#4759](https://github.com/NinaadRao/deepagents/issues/4759)) ([ab2e101](https://github.com/NinaadRao/deepagents/commit/ab2e101d02d0fc5be45b0581c4e04d441402dc29))
* **code:** infer additional model providers ([#4675](https://github.com/NinaadRao/deepagents/issues/4675)) ([4ceed24](https://github.com/NinaadRao/deepagents/commit/4ceed24d3758801ed9df1024602e90488004cef1))
* **code:** inject OpenAI `prompt_cache_key` for any OpenAI-provider endpoint ([#4995](https://github.com/NinaadRao/deepagents/issues/4995)) ([6d6632f](https://github.com/NinaadRao/deepagents/commit/6d6632fa39822f1b774fcabd61ed371a90427113))
* **code:** keep `/update` and `/install --package` prompts responsive ([#5127](https://github.com/NinaadRao/deepagents/issues/5127)) ([5726872](https://github.com/NinaadRao/deepagents/commit/5726872cd5efec9367ae2ce678aa7183af74335d))
* **code:** keep `task` timers monotonic across nested subagent HITL ([#4771](https://github.com/NinaadRao/deepagents/issues/4771)) ([6952011](https://github.com/NinaadRao/deepagents/commit/69520118a7f96866a5e92e7b31894d8ba3312938))
* **code:** keep chat input responsive during `/restart` ([#4808](https://github.com/NinaadRao/deepagents/issues/4808)) ([a915c59](https://github.com/NinaadRao/deepagents/commit/a915c590dfb7c50d9bf697953ce724bad8dd4149))
* **code:** keep chat input responsive during MCP viewer `Ctrl+R` reconnect ([#4753](https://github.com/NinaadRao/deepagents/issues/4753)) ([28dc96d](https://github.com/NinaadRao/deepagents/commit/28dc96d08bc057f2e435b557062a819db4191310))
* **code:** keep finished calls on live tool-group line ([#4927](https://github.com/NinaadRao/deepagents/issues/4927)) ([976c54b](https://github.com/NinaadRao/deepagents/commit/976c54b2e1392282044d9890a4a5d5d655f3e8dc))
* **code:** keep goal criteria proposal when marker clear fails ([#4785](https://github.com/NinaadRao/deepagents/issues/4785)) ([487b25f](https://github.com/NinaadRao/deepagents/commit/487b25f885c74b43ad2df837c6c0f6c45626be2a))
* **code:** keep harness-profile diagnostics out of terminal output ([#4943](https://github.com/NinaadRao/deepagents/issues/4943)) ([812bae4](https://github.com/NinaadRao/deepagents/commit/812bae4afad6749add097f9d58e489df9ec703a2))
* **code:** keep MCP shutdown-race traceback off the terminal ([#5325](https://github.com/NinaadRao/deepagents/issues/5325)) ([7d97097](https://github.com/NinaadRao/deepagents/commit/7d9709700dd24cc2477cd091f01de990f23ee4a9))
* **code:** keep paste placeholder when backspacing newline below it ([#4757](https://github.com/NinaadRao/deepagents/issues/4757)) ([ea82538](https://github.com/NinaadRao/deepagents/commit/ea825386b3c817f8461ea9e92c71de3411991e2a))
* **code:** keep post-install restart modal responsive ([#5086](https://github.com/NinaadRao/deepagents/issues/5086)) ([c4e2480](https://github.com/NinaadRao/deepagents/commit/c4e24804ebde93563f0596102bd5d9fc163ec0bf))
* **code:** keep server hook state out of task results ([#5164](https://github.com/NinaadRao/deepagents/issues/5164)) ([88ea7da](https://github.com/NinaadRao/deepagents/commit/88ea7da18e8be84e65df0edb8ffc4b904182f843))
* **code:** keep the `/goal` criteria prompt responsive ([#5142](https://github.com/NinaadRao/deepagents/issues/5142)) ([6f9ea6a](https://github.com/NinaadRao/deepagents/commit/6f9ea6a943dabe6c055766a43a204db6f4d95c98))
* **code:** keep TODO and edit tools expanded ([#4704](https://github.com/NinaadRao/deepagents/issues/4704)) ([1d549d3](https://github.com/NinaadRao/deepagents/commit/1d549d3f3c9bb60c3ce39d4a0c913bcefe9610d5))
* **code:** log underlying Auto classifier failures ([#5011](https://github.com/NinaadRao/deepagents/issues/5011)) ([bd03e8a](https://github.com/NinaadRao/deepagents/commit/bd03e8a1ca4b38883e11148d5614a444cdefa407))
* **code:** make `/goal` completion and grading reliable ([#4691](https://github.com/NinaadRao/deepagents/issues/4691)) ([9da63c6](https://github.com/NinaadRao/deepagents/commit/9da63c64a59503e3366e9bc7224cb1251af476be))
* **code:** make Auto mode generally available ([#4957](https://github.com/NinaadRao/deepagents/issues/4957)) ([1709dbf](https://github.com/NinaadRao/deepagents/commit/1709dbf9b27766aacce1a5a9c17396b3654f026c))
* **code:** make markdown `AppMessage` output selectable ([#4814](https://github.com/NinaadRao/deepagents/issues/4814)) ([2d6b2ce](https://github.com/NinaadRao/deepagents/commit/2d6b2ceeda97f8c77d1b3ea70c674b076e7d713f))
* **code:** make reject-with-feedback discoverable in approval menu ([#5260](https://github.com/NinaadRao/deepagents/issues/5260)) ([b1e3240](https://github.com/NinaadRao/deepagents/commit/b1e324038771c55460793e2e35d9d9ce5ea7b3f5))
* **code:** make YOLO warning friendlier for new users ([#4950](https://github.com/NinaadRao/deepagents/issues/4950)) ([fe07f39](https://github.com/NinaadRao/deepagents/commit/fe07f39ad78c5c09ea6959540a49196cd2f47f3e))
* **code:** match primary-input `Ctrl+D` behavior in inline free-text fields ([#4729](https://github.com/NinaadRao/deepagents/issues/4729)) ([8a6963b](https://github.com/NinaadRao/deepagents/commit/8a6963ba52eee2ab8de5df2c14210f472c828d38))
* **code:** move Auto mode path checks off the event loop ([#4856](https://github.com/NinaadRao/deepagents/issues/4856)) ([511203a](https://github.com/NinaadRao/deepagents/commit/511203a2c247f6756af3f06581ab9af761a4c4ef))
* **code:** offload server graph bootstrap cwd calls off the event loop ([#5081](https://github.com/NinaadRao/deepagents/issues/5081)) ([e05f7c2](https://github.com/NinaadRao/deepagents/commit/e05f7c2a825f3dc2fdfc075d4092b7b15d89b1a9))
* **code:** omit `plugins/` and `conversation_history/` from `/agent` picker ([#4991](https://github.com/NinaadRao/deepagents/issues/4991)) ([db26688](https://github.com/NinaadRao/deepagents/commit/db26688eee32232a1b73e98cc02642b5bf4165f4))
* **code:** open `/auto model` selector immediately while connecting ([#5341](https://github.com/NinaadRao/deepagents/issues/5341)) ([72bfc1e](https://github.com/NinaadRao/deepagents/commit/72bfc1e68574909ceb929be869c66fbdc9fe5a1d))
* **code:** partition Debug Console log retention by level ([#4718](https://github.com/NinaadRao/deepagents/issues/4718)) ([c6e3b35](https://github.com/NinaadRao/deepagents/commit/c6e3b351f1826aa6ea97be244acd867950a032ee))
* **code:** pin filelock below 3.30 to avoid blocking import ([#4786](https://github.com/NinaadRao/deepagents/issues/4786)) ([f9b7d75](https://github.com/NinaadRao/deepagents/commit/f9b7d75f24301081ae8973cd59f00e609eb024c5))
* **code:** preflight Ollama host reachability before discovery probe ([#4702](https://github.com/NinaadRao/deepagents/issues/4702)) ([96fe71a](https://github.com/NinaadRao/deepagents/commit/96fe71a3815e1020edeb3be1af70b0cadb85931c))
* **code:** preserve remembered MCP approvals with env allowlist ([#4889](https://github.com/NinaadRao/deepagents/issues/4889)) ([b513bf3](https://github.com/NinaadRao/deepagents/commit/b513bf3b2aaa30738da9b9b0ced1c001efb1bd5a))
* **code:** preserve runtime offload archive routing ([#5328](https://github.com/NinaadRao/deepagents/issues/5328)) ([768b061](https://github.com/NinaadRao/deepagents/commit/768b061805f65a36c71a1ad8f6a41b4e67063e91))
* **code:** prevent failed exit setup from stranding the app ([#4913](https://github.com/NinaadRao/deepagents/issues/4913)) ([e4d69b0](https://github.com/NinaadRao/deepagents/commit/e4d69b04a84de226d26d9ca3adea96f1337eef04))
* **code:** probe unreachable Ollama daemon once per reload ([#4806](https://github.com/NinaadRao/deepagents/issues/4806)) ([45baf6c](https://github.com/NinaadRao/deepagents/commit/45baf6c7a47e08e656ba56eb76beea30a9956403))
* **code:** put field descriptions on first-party tool schemas ([#5019](https://github.com/NinaadRao/deepagents/issues/5019)) ([4ccb873](https://github.com/NinaadRao/deepagents/commit/4ccb87325f3f97e416683233c94405e3ee105cda))
* **code:** put local offloaded tool results on the real filesystem ([#4740](https://github.com/NinaadRao/deepagents/issues/4740)) ([36051e2](https://github.com/NinaadRao/deepagents/commit/36051e2a6cdcd9c22f6118f5cfc481e0540913ea))
* **code:** quiet expected non-repo `git ls-files` logging ([#4701](https://github.com/NinaadRao/deepagents/issues/4701)) ([3d499db](https://github.com/NinaadRao/deepagents/commit/3d499db8a6c76743810a8983107d7c7d7bdb35e6))
* **code:** quiet MCP auth-skip debug logging for known patterns ([#4805](https://github.com/NinaadRao/deepagents/issues/4805)) ([c2c27d6](https://github.com/NinaadRao/deepagents/commit/c2c27d621b63d5af18870e034f99355dc410cbda))
* **code:** quit with `Ctrl+D` at end of prompt ([#4678](https://github.com/NinaadRao/deepagents/issues/4678)) ([2f8c111](https://github.com/NinaadRao/deepagents/commit/2f8c11176f5cc9350c3337b2dfcf9f19886d5d02))
* **code:** refresh hooks after cwd switches ([#5249](https://github.com/NinaadRao/deepagents/issues/5249)) ([6f48dd5](https://github.com/NinaadRao/deepagents/commit/6f48dd59efd27c3476cf32cb8c965155c59993a5))
* **code:** release the turn when an interrupted worker never starts ([#5196](https://github.com/NinaadRao/deepagents/issues/5196)) ([42e01a9](https://github.com/NinaadRao/deepagents/commit/42e01a9585be8847aff6b97e520d7b84de922767))
* **code:** remove plugin type-to-search caret flash ([#5078](https://github.com/NinaadRao/deepagents/issues/5078)) ([7d69e37](https://github.com/NinaadRao/deepagents/commit/7d69e379678d8491ab62c9e229426d50b7366c45))
* **code:** remove undispatched `SessionEndCause` members ([#5240](https://github.com/NinaadRao/deepagents/issues/5240)) ([ee1e0f5](https://github.com/NinaadRao/deepagents/commit/ee1e0f50bfaff3690c6164147cdf22c94c289768))
* **code:** rename `ls_agent_kind` to `ls_agent_purpose` ([#4708](https://github.com/NinaadRao/deepagents/issues/4708)) ([2678b16](https://github.com/NinaadRao/deepagents/commit/2678b1680d8928e72e8efae00632a694c9b2737a))
* **code:** report Auto classifier timeout budget ([#5025](https://github.com/NinaadRao/deepagents/issues/5025)) ([516619b](https://github.com/NinaadRao/deepagents/commit/516619b7bf516e56f0e56ebc319dcab928c68c40))
* **code:** require `AGENTS.md` marker for `/agent` discovery ([#5076](https://github.com/NinaadRao/deepagents/issues/5076)) ([aff1435](https://github.com/NinaadRao/deepagents/commit/aff1435ce8d56c623cfeffb2731adcd4bf057c30)), closes [#4991](https://github.com/NinaadRao/deepagents/issues/4991)
* **code:** resolve underspecified goal objectives from conversation context ([#5201](https://github.com/NinaadRao/deepagents/issues/5201)) ([8fdb9c3](https://github.com/NinaadRao/deepagents/commit/8fdb9c306fd9a5b5368eb065b100cbfe8c8cbc58))
* **code:** restore `"Server log preserved at:"` notice on exit ([#4999](https://github.com/NinaadRao/deepagents/issues/4999)) ([5bc7714](https://github.com/NinaadRao/deepagents/commit/5bc7714fe55a73ac4892deb1785522ea310607ce))
* **code:** restore marketplace details keyboard focus [closes DCD-50] ([#4763](https://github.com/NinaadRao/deepagents/issues/4763)) ([e821d3d](https://github.com/NinaadRao/deepagents/commit/e821d3dd26e8cd0c6ada1a44ceaceddad9f5ee80))
* **code:** resume hints echo the launched command name ([#5119](https://github.com/NinaadRao/deepagents/issues/5119)) ([991b7e7](https://github.com/NinaadRao/deepagents/commit/991b7e769d8afa98edc8dac1c68994ca4dc765d2))
* **code:** route `ctrl+x` to focused `ask_user` input ([#4926](https://github.com/NinaadRao/deepagents/issues/4926)) ([005f9bb](https://github.com/NinaadRao/deepagents/commit/005f9bb4d790e6cd92be8712ec86cd45192b699f))
* **code:** route explicit `--stdin` + `--skill` to headless path ([#4611](https://github.com/NinaadRao/deepagents/issues/4611)) ([724e24a](https://github.com/NinaadRao/deepagents/commit/724e24a31546e1f31feca3bb2344717550682595))
* **code:** route failures to `PostToolUseFailure` ([#5315](https://github.com/NinaadRao/deepagents/issues/5315)) ([c1f4ac3](https://github.com/NinaadRao/deepagents/commit/c1f4ac3d53b3231d80be97691763850d230e8080))
* **code:** run `/offload` server-side ([#4696](https://github.com/NinaadRao/deepagents/issues/4696)) ([564e5a0](https://github.com/NinaadRao/deepagents/commit/564e5a05bca5236ae33ce1147865111f931d257c))
* **code:** run MCP login during a run, queue the restart ([#4643](https://github.com/NinaadRao/deepagents/issues/4643)) ([65e1ee8](https://github.com/NinaadRao/deepagents/commit/65e1ee802e2f69762a6d8e6c7c6d37060161ea5a))
* **code:** scope selection copy to the clicked screen ([#5140](https://github.com/NinaadRao/deepagents/issues/5140)) ([4de6037](https://github.com/NinaadRao/deepagents/commit/4de6037cbe31de005a493eaa719f5269f29be764))
* **code:** share MCP approvals across Git worktrees ([#4939](https://github.com/NinaadRao/deepagents/issues/4939)) ([467f9dd](https://github.com/NinaadRao/deepagents/commit/467f9dd0400087c2918bcf19f270bd934cec623a))
* **code:** share paste handling with inline free-text prompts ([#4736](https://github.com/NinaadRao/deepagents/issues/4736)) ([369ec69](https://github.com/NinaadRao/deepagents/commit/369ec6920af35cdec713b9e27d0d1816cafaf556))
* **code:** show "Took &lt;duration&gt;" when `task` tool completes ([#4638](https://github.com/NinaadRao/deepagents/issues/4638)) ([19538e0](https://github.com/NinaadRao/deepagents/commit/19538e0a46a5c2c050412b79fd45608a63cdde52))
* **code:** show `-m` prompt as queued immediately on startup ([#4861](https://github.com/NinaadRao/deepagents/issues/4861)) ([d0e148a](https://github.com/NinaadRao/deepagents/commit/d0e148a72612137fc7bc1e49a8972643e0ca2c28))
* **code:** show Auto enable notice modal only on first global enable ([#5012](https://github.com/NinaadRao/deepagents/issues/5012)) ([c2dbd17](https://github.com/NinaadRao/deepagents/commit/c2dbd176f06ff1a29637107101ae61344a09fc59))
* **code:** show rubric grader defaults ([#4966](https://github.com/NinaadRao/deepagents/issues/4966)) ([465b9de](https://github.com/NinaadRao/deepagents/commit/465b9de17f9f4e6cd07a8674d9a186e60f5bf4d4))
* **code:** skip grading during `/goal` proposals ([#4941](https://github.com/NinaadRao/deepagents/issues/4941)) ([d1ce66e](https://github.com/NinaadRao/deepagents/commit/d1ce66ea03e3726e6077c6700fc480209a849a7e))
* **code:** stabilize hook resumes across identity and Command tool results ([#5176](https://github.com/NinaadRao/deepagents/issues/5176)) ([08e6e8b](https://github.com/NinaadRao/deepagents/commit/08e6e8ba8d8ea629d78976542a061a2acab1fa9c))
* **code:** stop duplicating Auto transcript events on interrupt replay ([#5157](https://github.com/NinaadRao/deepagents/issues/5157)) ([5bbcf42](https://github.com/NinaadRao/deepagents/commit/5bbcf428a8131f0fca149abba34096fbcd2dfde8))
* **code:** stop leaking turn coroutines and sqlite handles ([#5218](https://github.com/NinaadRao/deepagents/issues/5218)) ([994799b](https://github.com/NinaadRao/deepagents/commit/994799b2f25950eb76e1085b5026d1f19eceb563))
* **code:** support unambiguous `read_file` gutters ([#4711](https://github.com/NinaadRao/deepagents/issues/4711)) ([2089b54](https://github.com/NinaadRao/deepagents/commit/2089b54e2a674ede313e790b59febf9dc6f22571))
* **code:** surface `langchain-quickjs` in `/version` core deps ([#4813](https://github.com/NinaadRao/deepagents/issues/4813)) ([4112392](https://github.com/NinaadRao/deepagents/commit/41123924da6f6aa0243b51f2374210bee86df089))
* **code:** surface hook stops without agent errors ([#5276](https://github.com/NinaadRao/deepagents/issues/5276)) ([ed0e3e2](https://github.com/NinaadRao/deepagents/commit/ed0e3e236eea691d7c8c586ac1f9c82eba352b1a))
* **code:** surface tool calls awaiting approval ([#4739](https://github.com/NinaadRao/deepagents/issues/4739)) ([8148724](https://github.com/NinaadRao/deepagents/commit/814872492eb2bed4d5c382c6c1fe985ad4354b68))
* **code:** sync `ask_user` active-question highlight with focus ([#4599](https://github.com/NinaadRao/deepagents/issues/4599)) ([e4c29b5](https://github.com/NinaadRao/deepagents/commit/e4c29b5264413d23d8dc70cabae72feb5f3f3dcb))
* **code:** targeted uv constraints for dcode prerelease deps ([#4744](https://github.com/NinaadRao/deepagents/issues/4744)) ([36c4024](https://github.com/NinaadRao/deepagents/commit/36c40241b85ec5b0452d9ca334e5f09b95dc16aa))
* **code:** thread id always copies on click in Debug Console ([#4945](https://github.com/NinaadRao/deepagents/issues/4945)) ([b4cb393](https://github.com/NinaadRao/deepagents/commit/b4cb3937bf8883e616f47621547a775ce9b29995))
* **code:** toast and expand long transcript user messages ([#5073](https://github.com/NinaadRao/deepagents/issues/5073)) ([a34713b](https://github.com/NinaadRao/deepagents/commit/a34713b122383dccad2572cd7213fd56f467fcce))
* **code:** toast model no-op notice instead of inline message ([#5074](https://github.com/NinaadRao/deepagents/issues/5074)) ([92b5193](https://github.com/NinaadRao/deepagents/commit/92b519391f584acb7786121469e45e850a94e06c))
* **code:** toast when media is dropped into a free-text question ([#5099](https://github.com/NinaadRao/deepagents/issues/5099)) ([da8d4c3](https://github.com/NinaadRao/deepagents/commit/da8d4c3ccc237e57294088d2437b13031a73c52d))
* **code:** trim `web_search` and `fetch_url` tool descriptions ([#5016](https://github.com/NinaadRao/deepagents/issues/5016)) ([170b4a6](https://github.com/NinaadRao/deepagents/commit/170b4a6c4590b3f95fb5219b5d9074c7f01a1937))
* **code:** use dismissed copy for ask-user prompts ([#5331](https://github.com/NinaadRao/deepagents/issues/5331)) ([920fb66](https://github.com/NinaadRao/deepagents/commit/920fb66763e85b759c2ec3cac090bccd7f05b55f))
* **code:** use SDK pin as effective editable version ([#4949](https://github.com/NinaadRao/deepagents/issues/4949)) ([1b270c8](https://github.com/NinaadRao/deepagents/commit/1b270c86fe24381c28d3ed35a31d754bd58bbf6e))
* **code:** warm MCP auth imports off event loop ([#4855](https://github.com/NinaadRao/deepagents/issues/4855)) ([75d37c3](https://github.com/NinaadRao/deepagents/commit/75d37c347556d962ff14850bdde489657c86feb4))
* **code:** wrap MCP viewer navigation ([#4677](https://github.com/NinaadRao/deepagents/issues/4677)) ([cffc732](https://github.com/NinaadRao/deepagents/commit/cffc73213bfdcec26cb82c413fa7e27db4afc0ca))


### Performance Improvements

* **code:** coordinate async shutdown teardown to cut exit latency ([#4831](https://github.com/NinaadRao/deepagents/issues/4831)) ([a2e501b](https://github.com/NinaadRao/deepagents/commit/a2e501b71f3d91769f56d5b3e433af8e03f7656e))
* **code:** refresh `/threads` cache after each turn ([#5174](https://github.com/NinaadRao/deepagents/issues/5174)) ([872f9d5](https://github.com/NinaadRao/deepagents/commit/872f9d5647759a84e7abfa79d43fc128c54e29a4))
* **code:** speed up local context detection ([#4922](https://github.com/NinaadRao/deepagents/issues/4922)) ([0b512d4](https://github.com/NinaadRao/deepagents/commit/0b512d4b79b1a03c7e452f1e76350cf726b1ec38))


### Reverted Changes

* **code,sdk:** revert `SystemPromptConfig` ([#4969](https://github.com/NinaadRao/deepagents/issues/4969)) ([d046427](https://github.com/NinaadRao/deepagents/commit/d046427b536c8ddbce5d804d6ae8b860511a9b44))
